...
{-
    ...
    * https://thriveedservices.com/syllable-division-rules-how-to-divide-words-into-syllables/
    ...
    Rule 3: V/CV & VC/V – Split before or after a consonant that comes between 2 vowels. <- hard to algorithmicly implement
...
vPortion cc@(c1 : c2 : cs) syllable n
    | any (`isPrefixOf` cc) vowelTeams2 = cPortion cs (syllable ++ [c1, c2]) (n + 1) -- legal VV vowelTeams in 1 syllable
...
cPortion cc@(c1 : c2 : cs@(c3 : css)) syllable n
    ...
    | isConsTeams3 = vPortion css (syllable ++ [c1, c2, c3]) (n + 1) -- legal CCC consTeams in 1 syllable
    | isConsTeams2 = vPortion cs (syllable ++ [c1, c2]) (n + 1) -- legal CC in 1 syllable
